		...
		<div class="container register-form">
			...
			?>
				...
				<div class="form-content">
					...
					<!-- Phone# -->
					<div class="form-group">
						<input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter your phone number" required maxlength="10">
					</div>
					...
					<p class="mt-3">Already registered? <a href="#" onclick="redirectToLogin()">Login here</a></p></div>
					<div><p>Go Back? <a href="frontpage.php"> Home </a></p></div>
